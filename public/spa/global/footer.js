...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t22 = space();
			p = element("p");
			t23 = text("Lorem ipsum dolor sit amet, consectetur elit. Consjat tristique eget amet, tempus eu at cttur.");
			t24 = space();
			ul3 = element("ul");
			li8 = element("li");
			a9 = element("a");
		...
		l(nodes) {
			...
			t14 = claim_text(div4_nodes, "Support");
			...
			t18 = claim_text(a6_nodes, "Privacy Policy");
			...
			t20 = claim_text(a7_nodes, "Terms & Conditions");
			...
			a8 = claim_element(div6_nodes, "A", { class: true, href: true });
			var a8_nodes = children(a8);

			img = claim_element(a8_nodes, "IMG", {
				width: true,
				class: true,
				src: true,
				alt: true
			...
			t23 = claim_text(p_nodes, "Lorem ipsum dolor sit amet, consectetur elit. Consjat tristique eget amet, tempus eu at cttur.");
			...
			a9 = claim_element(li8_nodes, "A", { href: true, "aria-label": true });
			var a9_nodes = children(a9);
			i0 = claim_element(a9_nodes, "I", { class: true });
			...
			i1 = claim_element(a10_nodes, "I", { class: true });
			...
			i2 = claim_element(a11_nodes, "I", { class: true });
			...
			i3 = claim_element(a12_nodes, "I", { class: true });
		...
		h() {
			...
			attr(a6, "href", "privacy-policy");
			attr(a6, "class", "svelte-igpv26");
			attr(a7, "href", "terms-conditions");
			...
			attr(a8, "class", "d-block mb-3");
			attr(a8, "href", ".");
			attr(p, "class", "mb-4");
			attr(i0, "class", "ti-facebook svelte-igpv26");
			attr(a9, "href", "https://www.facebook.com/");
			attr(a9, "aria-label", "Facebook");
			attr(li8, "class", "list-inline-item");
			attr(i1, "class", "ti-twitter-alt svelte-igpv26");
			attr(a10, "href", "https://twitter.com/");
			attr(a10, "aria-label", "Twitter");
			attr(li9, "class", "list-inline-item");
			attr(i2, "class", "ti-skype svelte-igpv26");
			attr(a11, "href", ".");
			attr(a11, "aria-label", "Skype");
			attr(li10, "class", "list-inline-item");
			attr(i3, "class", "ti-linkedin svelte-igpv26");
			attr(a12, "href", "https://www.linkedin.com/");
			attr(a12, "aria-label", "LinkedIn");
