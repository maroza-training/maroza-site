<footer class="bg-light section pb-0">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-5">
        <a class="d-block mb-3" href="."><img width="200px" class="img-fluid" src="assets/logo.svg" alt="Bigspring Hugo"></a>
        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur elit. Consjat tristique eget amet, tempus eu at cttur.</p>

        <ul class="list-inline social-icons">
          <li class="list-inline-item"><a href="https://www.facebook.com/" aria-label="Facebook"><i class="ti-facebook"></i></a></li>
          <li class="list-inline-item"><a href="https://twitter.com/" aria-label="Twitter"><i class="ti-twitter-alt"></i></a></li>
          <li class="list-inline-item"><a href="." aria-label="Skype"><i class="ti-skype"></i></a></li>
          <li class="list-inline-item"><a href="https://www.linkedin.com/" aria-label="LinkedIn"><i class="ti-linkedin"></i></a></li>
        </ul>
      </div>
    </div>
